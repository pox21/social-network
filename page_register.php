              ...
              <div class="card p-4 rounded-plus bg-faded">
                <?php if (isset($_SESSION['errorRegister']) && !empty($_SESSION['errorRegister']) ) { ?>
                  <div class="alert alert-danger text-dark" role="alert">
                    <strong>Уведомление!</strong> <?php displayFlashMessage('errorRegister')?>
                  </div>
                <?php } ?>
                <form id="js-login" novalidate="" action="includes/register.php" method="post">
                  ...
                  <div class="row no-gutters">
                    <div class="col-md-4 ml-auto text-right">
                      <button id="js-login-btn" type="submit" class="btn btn-block btn-danger btn-lg mt-3">Регистрация
                      </button>
                    </div>
                  </div>
                </form>
