...
<main id="js-page-content" role="main" class="page-content mt-3">
  <?php if (isset($_SESSION['updateData']) && !empty($_SESSION['updateData']) ) { ?>
    <div class="alert alert-success">
      <?php displayFlashMessage('updateData') ?>
    </div>
  <?php } ?>
  <div class="subheader">
        ...
        <div class="card-body p-0 collapse show">
          <div class="p-3">
            <a href="tel:+<?=$user["phone"]?>" class="mt-1 d-block fs-sm fw-400 text-dark">
              <i class="fas fa-mobile-alt text-muted mr-2"></i>+<?=phoneFormat($user["phone"])?></a>
