...
<div class="blankpage-form-field">
  ...
  <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
    ...
    <?php } ?>
    <?php if (isset($_SESSION['errorLogin']) && !empty($_SESSION['errorLogin']) ) { ?>
      <div class="alert alert-danger">
          <?php displayFlashMessage('errorLogin')?>
      </div>
    <?php } ?>
    ...
    <form action="includes/login.php" method="post">
      <div class="form-group">
        ...
        <input type="email" id="username" class="form-control" placeholder="Эл. адрес"
               value="<?php echo isset($_SESSION['email']) ? $_SESSION['email'] : '' ?>" name="email">
      </div>
      <div class="form-group">
